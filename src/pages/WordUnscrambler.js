    ...
    <>
      ...
      <div className="page-container">
        ...
        <section className="middle-section">
          <h2>What is Word Unscrambler?</h2>
          <p>
            The Word Unscrambler helps you find all possible words from scrambled letters. Perfect for games like Scrabble and Words With Friends.
          </p>
        </section>
      </div>
      <Footer /> {/* Add Footer */}
